...
RUN echo "installing dbgsym-keyring"; apt-get install -y ubuntu-dbgsym-keyring
...
RUN echo "installing base tools"; apt-get install -y vim bash git rocminfo
...
RUN echo "Install all ROCm test packages"; apt-get install -y rocm-tests

############################################################
# clone rocm-inbox-testing
############################################################

RUN git clone https://github.com/AMD-Linux-Open-Source-Graphics/rocm-inbox-testing.git /opt/rocm-inbox-testing
